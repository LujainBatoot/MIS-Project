	...
	<div id="request" class="tabcontent">
            <div class="center">
                <form acion="" method="POST">
                    ...
                    <button type="submit" class="req-btn" name="req-btn" onclick="myAlert()">إرسال</button>
                    <br>
                    <?php
        ...
        <table class = "gfg">
          <form action ="" method="POST">
            ...
            <td><?php echo $result['period'];?></td>
              ...
              <td>
              <button type="submit" class="cancel-btn"<?php if($isDisabled == true){?> disabled <?php } ?> value="<?php echo $result['fazaa_ID'];?>" name="cancel-btn" onclick="myAlert1()">إلغاء الطلب</button>
              </td>
              <?php 
